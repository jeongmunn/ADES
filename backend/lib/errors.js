...
// a constructor function for creating error objects
...
errors.not_registeration = new ApiError(404, 'NOT_REGISTERATION','User not registered with this userid.');
errors.invalid_request = new ApiError(422, 'UNPROCESSABLE ENTITY', 'The request is well-formed but was unable to be followed due to semantic errors.');
