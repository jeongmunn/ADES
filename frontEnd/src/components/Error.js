    ...
    return (
        <div className="permission_denied">
            ...
            <div className="denied__wrapper">
                <h1>404</h1>
                <h3>LOST IN <span>quizment</span> space? Hmm, looks like that page doesn't exist.</h3>
                ...
                <a href="http://localhost:8081.com/quizment/"><button class="denied__link">Go Home</button></a>
            </div>
        </div>
    )
}
