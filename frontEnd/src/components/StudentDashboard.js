...
class StudentDashboard extends React.Component {
    ...
    componentDidMount() {
        axios.get('https://ades-ca1-heroku.herokuapp.com/api/topStudents/')
            .then(res => {
                this.setState({ data: res.data });
            })

        axios.get('https://ades-ca1-heroku.herokuapp.com/api/streaks/' + 4)
            .then(res => {
        ...
        axios.get('https://ades-ca1-heroku.herokuapp.com/api/points/' + 4)
            .then(res => {
        ...
        axios.get('https://ades-ca1-heroku.herokuapp.com/api/lastLogin/' + 4)
            .then(res => {
                ...
                if (diffTime >= 28800000 && diffTime <= 86400000) {
                    ...
                    axios.put('https://ades-ca1-heroku.herokuapp.com/api/lastLoginStreak/' + 4, lastLog, config)
                    .then(res => {
                    ...
                    axios.put('https://ades-ca1-heroku.herokuapp.com/api/updatePoints/' + 4)
                    .then(res => {
                        console.log("RESULTS: " + res);
                        console.log(res);
                        console.log("RESULT: " + res.data);
                    ...
                    console.log("harooo");
                    axios.put('https://ades-ca1-heroku.herokuapp.com/api/lastLoginLostStreak/' + 4, lastLog, config)
                        .then(res => {
                            console.log("RESULTS: " + res);
                            console.log(res);
                            console.log("RESULT: " + res.data);
                    ...
                    console.log("BYE");
                    axios.put('https://ades-ca1-heroku.herokuapp.com/api/lastLogin/' + 4, lastLog, config)
                        .then(res => {
                            console.log("RESULTS: " + res);
                            console.log(res);
                            console.log("RESULT: " + res.data);
