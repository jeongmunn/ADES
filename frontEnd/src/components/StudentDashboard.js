                ...
                axios.get(`http://localhost:8081/api/userType/` + this.state.uid, config)
                    .then(res => {
                        if (res.data.type === 1) {
                            ...
                            // here are those
                            axios.get('http://localhost:8081/api/students/streaks/' + this.state.id)
                                .then(res => {
                            ...
                            axios.get('http://localhost:8081/api/students/points/' + this.state.id)
                                .then(res => {
                            ...
                            axios.get('http://localhost:8081/api/students/lastLogin/' + this.state.id)
                                .then(res => {
                                    ...
                                    if (diffTime >= 28800000 && diffTime <= 86400000) {
                                        ...
                                        axios.put('http://localhost:8081/api/students/lastLoginStreak/' + this.state.id, lastLog, config)
                                            .then(res => {
                                        ...
                                        axios.put('http://localhost:8081/api/students/updatePoints/' + this.state.id)
                                            .then(res => {
                                                console.log("RESULTS: " + res);
                                                console.log(res);
                                                console.log("RESULT: " + res.data);
                                        ...
                                        console.log("harooo");
                                        axios.put('http://localhost:8081/api/students/lastLoginLostStreak/' + this.state.id, lastLog, config)
                                            .then(res => {
                                                console.log("RESULTS: " + res);
                                                console.log(res);
                                                console.log("RESULT: " + res.data);
                                        ...
                                        console.log("BYE");
                                        axios.put('http://localhost:8081/api/students/lastLogin/' + this.state.id, lastLog, config)
                                            .then(res => {
                                                console.log("RESULTS: " + res);
                                                console.log(res);
                                                console.log("RESULT: " + res.data);
